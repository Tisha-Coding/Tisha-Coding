<!-- ════════════════════════════════════════════════════════════════
     HERO — Premium Wave Header
═════════════════════════════════════════════════════════════════ -->

<a href="https://github.com/Tisha-Coding">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:0F172A,35:2563EB,70:0EA5E9,100:60A5FA&height=260&section=header&text=Tisha&fontSize=96&fontAlignY=36&fontColor=F8FAFC&desc=Full%20Stack%20Developer%20%E2%80%A2%20AI-Integrated%20Web%20Applications&descAlignY=58&descAlign=50&descSize=18&animation=fadeIn" width="100%"/>
</a>

<div align="center">

<a href="https://github.com/Tisha-Coding">
  <img src="https://readme-typing-svg.demolab.com?font=Inter&weight=600&size=22&duration=3200&pause=900&color=2563EB&center=true&vCenter=true&width=780&height=46&lines=Full+Stack+Developer+%E2%80%A2+AI-Integrated+Web+Apps;React.js+%7C+Next.js+%7C+Node.js+%7C+TypeScript;PostgreSQL+%7C+MongoDB+%7C+Prisma+%7C+REST+APIs;Building+production-grade+%2B+AI-powered+full-stack+products" alt="Typing animation" />
</a>
...
I'm a **Full Stack Web Developer** with **1+ year of professional experience** building scalable, secure, and responsive web applications. My core stack is **React.js, Next.js, Node.js, TypeScript, and PostgreSQL** — and I love bringing **AI-powered features** into real-world products using tools like the **Groq API**.

From banking analytics dashboards used by **80+ managers** to AI-assisted e-commerce platforms with **Stripe & Razorpay** payments, I focus on **clean architecture, performant APIs, and pixel-precise UI**.

Currently **open to Full Stack & Frontend opportunities** where I can ship meaningful products and keep growing.
...
&nbsp;&nbsp;&nbsp;End-to-end ownership — schema design → deployed UI.

**▸ &nbsp;API Architecture & Data-Driven Apps**
&nbsp;&nbsp;&nbsp;REST APIs with pagination, debounced search, DB indexing.

**▸ &nbsp;Authentication & Authorization**
&nbsp;&nbsp;&nbsp;JWT, NextAuth, bcrypt hashing, role-based access control.

</td>
<td valign="top" width="50%">

**▸ &nbsp;Performance-Focused Engineering**
&nbsp;&nbsp;&nbsp;Optimistic UI, atomic DB increments, query optimization.

**▸ &nbsp;AI-Powered Feature Integration**
&nbsp;&nbsp;&nbsp;Production chatbots with Groq API + AI-assisted dev workflows.

**▸ &nbsp;Clean UI & Production Thinking**
&nbsp;&nbsp;&nbsp;Reusable components, responsive design, real shipping mindset.
...
### &nbsp;PulseFeed &nbsp;—&nbsp; *YouTube × Medium in one infinite feed*
...
- &nbsp;**Atomic PostgreSQL increments** for like/bookmark counters under concurrent traffic
- &nbsp;**Optimistic UI** + debounced watch/read progress sync — resume exactly where you left off
- &nbsp;Role-based **admin console** with NextAuth JWT sessions + Zod validation on every API route
...
### &nbsp;E-Commerce Web Application &nbsp;—&nbsp; *Full-stack shop with AI assistant*
...
- &nbsp;Dual payment gateways — **Stripe + Razorpay** multi-method checkout
- &nbsp;**AI-powered chatbot** built with Groq API for real-time product queries and order tracking
- &nbsp;JWT auth + email-based password reset via Nodemailer + Cloudinary image uploads
...
### &nbsp;Team Task Manager &nbsp;—&nbsp; *Secure collaboration platform with RBAC*
...
- &nbsp;Normalized **PostgreSQL schema** with parameterized queries, upsert patterns, and indexed joins
- &nbsp;**Axios interceptor pipeline** for automatic token injection
- &nbsp;**Redux Toolkit slices** for optimistic UI state management
